...
0.16.0's self-hosted backends (this repo's own hosted CI, 2026-09-02): an f32
argument after more than 6 integer-class parameters arrived as 0 on
x86_64-linux, and the all-float 16-byte `meshopt_CoverageStatistics` return
arrived garbled there and on aarch64-macos. LLVM builds and Windows were
measured clean. The idiomatic layer therefore crosses the 9 affected
